...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("images/cell.png",loader);
	...
	if(ApplicationMain.total == 0) ApplicationMain.begin(); else {
		...
		while( $it0.hasNext() ) {
			...
			loader1.load(new browser.net.URLRequest(path));
		}
...
ApplicationMain.preloader_onComplete = function(event) {
	...
	if(Reflect.field(org.games.life.Main,"main") == null) {
		var mainDisplayObj = new org.games.life.Main();
		if(js.Boot.__instanceof(mainDisplayObj,browser.display.DisplayObject)) nme.Lib.get_current().addChild(mainDisplayObj);
	} else Reflect.field(org.games.life.Main,"main").apply(org.games.life.Main,[]);
}
...
var com = {}
com.eclecticdesignstudio = {}
com.eclecticdesignstudio.motion = {}
com.eclecticdesignstudio.motion.easing = {}
com.eclecticdesignstudio.motion.easing.Expo = function() { }
$hxClasses["com.eclecticdesignstudio.motion.easing.Expo"] = com.eclecticdesignstudio.motion.easing.Expo;
com.eclecticdesignstudio.motion.easing.Expo.__name__ = ["com","eclecticdesignstudio","motion","easing","Expo"];
com.eclecticdesignstudio.motion.easing.Expo.__properties__ = {get_easeOut:"get_easeOut"}
com.eclecticdesignstudio.motion.easing.Expo.get_easeIn = function() {
	return new com.eclecticdesignstudio.motion.easing.ExpoEaseIn();
}
com.eclecticdesignstudio.motion.easing.Expo.get_easeInOut = function() {
	return new com.eclecticdesignstudio.motion.easing.ExpoEaseInOut();
}
com.eclecticdesignstudio.motion.easing.Expo.get_easeOut = function() {
	return new com.eclecticdesignstudio.motion.easing.ExpoEaseOut();
}
com.eclecticdesignstudio.motion.easing.IEasing = function() { }
$hxClasses["com.eclecticdesignstudio.motion.easing.IEasing"] = com.eclecticdesignstudio.motion.easing.IEasing;
...
com.eclecticdesignstudio.motion.easing.ExpoEaseOut = function() {
};
$hxClasses["com.eclecticdesignstudio.motion.easing.ExpoEaseOut"] = com.eclecticdesignstudio.motion.easing.ExpoEaseOut;
...
com.eclecticdesignstudio.motion._Actuate = {}
com.eclecticdesignstudio.motion._Actuate.ObjectHash = function() {
	this.hash = new IntHash();
};
$hxClasses["com.eclecticdesignstudio.motion._Actuate.ObjectHash"] = com.eclecticdesignstudio.motion._Actuate.ObjectHash;
...
com.eclecticdesignstudio.motion.Actuate = function() { }
$hxClasses["com.eclecticdesignstudio.motion.Actuate"] = com.eclecticdesignstudio.motion.Actuate;
...
com.eclecticdesignstudio.motion.Actuate.unload = function(actuator) {
	...
	if(com.eclecticdesignstudio.motion.Actuate.targetLibraries.hash.exists((function($this) {
		...
		HxOverrides.remove(com.eclecticdesignstudio.motion.Actuate.targetLibraries.hash.get((function($this) {
			var $r;
			if(target.___id___ == null) {
				target.___id___ = com.eclecticdesignstudio.motion._Actuate.ObjectHash.nextObjectID++;
				if(com.eclecticdesignstudio.motion._Actuate.ObjectHash.nextObjectID == 1073741823) com.eclecticdesignstudio.motion._Actuate.ObjectHash.nextObjectID = 0;
...
com.eclecticdesignstudio.motion.MotionPath = function() { }
$hxClasses["com.eclecticdesignstudio.motion.MotionPath"] = com.eclecticdesignstudio.motion.MotionPath;
com.eclecticdesignstudio.motion.MotionPath.__name__ = ["com","eclecticdesignstudio","motion","MotionPath"];
com.eclecticdesignstudio.motion.MotionPath.prototype = {
	get_y: function() {
		return this._y;
	}
	,get_x: function() {
	...
	,__class__: com.eclecticdesignstudio.motion.MotionPath
}
com.eclecticdesignstudio.motion.IComponentPath = function() { }
$hxClasses["com.eclecticdesignstudio.motion.IComponentPath"] = com.eclecticdesignstudio.motion.IComponentPath;
com.eclecticdesignstudio.motion.IComponentPath.__name__ = ["com","eclecticdesignstudio","motion","IComponentPath"];
com.eclecticdesignstudio.motion.IComponentPath.prototype = {
	__class__: com.eclecticdesignstudio.motion.IComponentPath
	,__properties__: {get_end:"get_end"}
}
com.eclecticdesignstudio.motion.ComponentPath = function() { }
$hxClasses["com.eclecticdesignstudio.motion.ComponentPath"] = com.eclecticdesignstudio.motion.ComponentPath;
com.eclecticdesignstudio.motion.ComponentPath.__name__ = ["com","eclecticdesignstudio","motion","ComponentPath"];
com.eclecticdesignstudio.motion.ComponentPath.__interfaces__ = [com.eclecticdesignstudio.motion.IComponentPath];
com.eclecticdesignstudio.motion.ComponentPath.prototype = {
	get_end: function() {
	...
	,__class__: com.eclecticdesignstudio.motion.ComponentPath
	,__properties__: {get_end:"get_end"}
}
com.eclecticdesignstudio.motion.BezierPath = function() { }
$hxClasses["com.eclecticdesignstudio.motion.BezierPath"] = com.eclecticdesignstudio.motion.BezierPath;
com.eclecticdesignstudio.motion.BezierPath.__name__ = ["com","eclecticdesignstudio","motion","BezierPath"];
com.eclecticdesignstudio.motion.BezierPath.prototype = {
	calculate: function(start,k) {
		return (1 - k) * (1 - k) * start + 2 * (1 - k) * k * this.control + k * k * this.end;
	}
	,__class__: com.eclecticdesignstudio.motion.BezierPath
}
com.eclecticdesignstudio.motion.LinearPath = function() { }
$hxClasses["com.eclecticdesignstudio.motion.LinearPath"] = com.eclecticdesignstudio.motion.LinearPath;
com.eclecticdesignstudio.motion.LinearPath.__name__ = ["com","eclecticdesignstudio","motion","LinearPath"];
com.eclecticdesignstudio.motion.LinearPath.__super__ = com.eclecticdesignstudio.motion.BezierPath;
com.eclecticdesignstudio.motion.LinearPath.prototype = $extend(com.eclecticdesignstudio.motion.BezierPath.prototype,{
	calculate: function(start,k) {
		return start + k * (this.end - start);
	}
	,__class__: com.eclecticdesignstudio.motion.LinearPath
});
com.eclecticdesignstudio.motion.actuators = {}
com.eclecticdesignstudio.motion.actuators.IGenericActuator = function() { }
$hxClasses["com.eclecticdesignstudio.motion.actuators.IGenericActuator"] = com.eclecticdesignstudio.motion.actuators.IGenericActuator;
...
com.eclecticdesignstudio.motion.actuators.GenericActuator = function(target,duration,properties) {
...
$hxClasses["com.eclecticdesignstudio.motion.actuators.GenericActuator"] = com.eclecticdesignstudio.motion.actuators.GenericActuator;
...
com.eclecticdesignstudio.motion.actuators.SimpleActuator = function(target,duration,properties) {
	this.active = true;
	...
	if(com.eclecticdesignstudio.motion.actuators.SimpleActuator.shape == null) {
		com.eclecticdesignstudio.motion.actuators.SimpleActuator.shape = new browser.display.Shape();
		nme.Lib.get_current().get_stage().addEventListener(browser.events.Event.ENTER_FRAME,com.eclecticdesignstudio.motion.actuators.SimpleActuator.shape_onEnterFrame);
	}
};
$hxClasses["com.eclecticdesignstudio.motion.actuators.SimpleActuator"] = com.eclecticdesignstudio.motion.actuators.SimpleActuator;
...
com.eclecticdesignstudio.motion.actuators.SimpleActuator.prototype = $extend(com.eclecticdesignstudio.motion.actuators.GenericActuator.prototype,{
	...
	,initialize: function() {
		...
		while(_g < _g1.length) {
			...
			details = new com.eclecticdesignstudio.motion.actuators.PropertyDetails(this.target,i,start,Reflect.field(this.properties,i) - start,isField);
...
com.eclecticdesignstudio.motion.actuators.FilterActuator = function() { }
$hxClasses["com.eclecticdesignstudio.motion.actuators.FilterActuator"] = com.eclecticdesignstudio.motion.actuators.FilterActuator;
...
com.eclecticdesignstudio.motion.actuators.MethodActuator = function() { }
$hxClasses["com.eclecticdesignstudio.motion.actuators.MethodActuator"] = com.eclecticdesignstudio.motion.actuators.MethodActuator;
...
com.eclecticdesignstudio.motion.actuators.MotionPathActuator = function() { }
$hxClasses["com.eclecticdesignstudio.motion.actuators.MotionPathActuator"] = com.eclecticdesignstudio.motion.actuators.MotionPathActuator;
com.eclecticdesignstudio.motion.actuators.MotionPathActuator.__name__ = ["com","eclecticdesignstudio","motion","actuators","MotionPathActuator"];
com.eclecticdesignstudio.motion.actuators.MotionPathActuator.__super__ = com.eclecticdesignstudio.motion.actuators.SimpleActuator;
com.eclecticdesignstudio.motion.actuators.MotionPathActuator.prototype = $extend(com.eclecticdesignstudio.motion.actuators.SimpleActuator.prototype,{
	update: function(currentTime) {
		if(!this.paused) {
			var details;
			var easing;
			...
			if(!this.special) {
				...
				while(_g < _g1.length) {
					var details1 = _g1[_g];
					++_g;
					if(details1.isField) details1.target[details1.propertyName] = (js.Boot.__cast(details1 , com.eclecticdesignstudio.motion.actuators.PropertyPathDetails)).path.calculate(easing); else Reflect.setProperty(details1.target,details1.propertyName,(js.Boot.__cast(details1 , com.eclecticdesignstudio.motion.actuators.PropertyPathDetails)).path.calculate(easing));
				}
			} else {
				if(!this._reverse) easing = this._ease.calculate(tweenPosition); else easing = this._ease.calculate(1 - tweenPosition);
				var endValue;
				...
				while(_g < _g1.length) {
					...
					if(!this._snapping) {
						if(details1.isField) details1.target[details1.propertyName] = (js.Boot.__cast(details1 , com.eclecticdesignstudio.motion.actuators.PropertyPathDetails)).path.calculate(easing); else Reflect.setProperty(details1.target,details1.propertyName,(js.Boot.__cast(details1 , com.eclecticdesignstudio.motion.actuators.PropertyPathDetails)).path.calculate(easing));
					} else if(details1.isField) details1.target[details1.propertyName] = Math.round((js.Boot.__cast(details1 , com.eclecticdesignstudio.motion.actuators.PropertyPathDetails)).path.calculate(easing)); else Reflect.setProperty(details1.target,details1.propertyName,Math.round((js.Boot.__cast(details1 , com.eclecticdesignstudio.motion.actuators.PropertyPathDetails)).path.calculate(easing)));
				}
			}
			if(tweenPosition == 1) {
				if(this._repeat == 0) {
	...
	,initialize: function() {
		...
		while(_g < _g1.length) {
			var propertyName = _g1[_g];
			++_g;
			path = js.Boot.__cast(Reflect.field(this.properties,propertyName) , com.eclecticdesignstudio.motion.IComponentPath);
			if(path != null) {
				var isField = true;
				...
				details = new com.eclecticdesignstudio.motion.actuators.PropertyPathDetails(this.target,propertyName,path,isField);
				this.propertyDetails.push(details);
			}
		}
		this.detailsLength = this.propertyDetails.length;
	...
	,apply: function() {
		...
		while(_g < _g1.length) {
			var propertyName = _g1[_g];
			++_g;
			if(Reflect.hasField(this.target,propertyName)) this.target[propertyName] = (js.Boot.__cast(Reflect.field(this.properties,propertyName) , com.eclecticdesignstudio.motion.IComponentPath)).get_end(); else Reflect.setProperty(this.target,propertyName,(js.Boot.__cast(Reflect.field(this.properties,propertyName) , com.eclecticdesignstudio.motion.IComponentPath)).get_end());
		}
	}
	,__class__: com.eclecticdesignstudio.motion.actuators.MotionPathActuator
});
com.eclecticdesignstudio.motion.actuators.PropertyDetails = function(target,propertyName,start,change,isField) {
...
$hxClasses["com.eclecticdesignstudio.motion.actuators.PropertyDetails"] = com.eclecticdesignstudio.motion.actuators.PropertyDetails;
...
com.eclecticdesignstudio.motion.actuators.PropertyPathDetails = function(target,propertyName,path,isField) {
	if(isField == null) isField = true;
	com.eclecticdesignstudio.motion.actuators.PropertyDetails.call(this,target,propertyName,0,0,isField);
	this.path = path;
};
$hxClasses["com.eclecticdesignstudio.motion.actuators.PropertyPathDetails"] = com.eclecticdesignstudio.motion.actuators.PropertyPathDetails;
com.eclecticdesignstudio.motion.actuators.PropertyPathDetails.__name__ = ["com","eclecticdesignstudio","motion","actuators","PropertyPathDetails"];
com.eclecticdesignstudio.motion.actuators.PropertyPathDetails.__super__ = com.eclecticdesignstudio.motion.actuators.PropertyDetails;
com.eclecticdesignstudio.motion.actuators.PropertyPathDetails.prototype = $extend(com.eclecticdesignstudio.motion.actuators.PropertyDetails.prototype,{
	__class__: com.eclecticdesignstudio.motion.actuators.PropertyPathDetails
});
com.eclecticdesignstudio.motion.actuators.TransformActuator = function() { }
$hxClasses["com.eclecticdesignstudio.motion.actuators.TransformActuator"] = com.eclecticdesignstudio.motion.actuators.TransformActuator;
...
com.eclecticdesignstudio.motion.easing.ExpoEaseIn = function() {
};
$hxClasses["com.eclecticdesignstudio.motion.easing.ExpoEaseIn"] = com.eclecticdesignstudio.motion.easing.ExpoEaseIn;
...
com.eclecticdesignstudio.motion.easing.ExpoEaseInOut = function() {
};
$hxClasses["com.eclecticdesignstudio.motion.easing.ExpoEaseInOut"] = com.eclecticdesignstudio.motion.easing.ExpoEaseInOut;
...
nme.installer.Assets.initialize = function() {
	if(!nme.installer.Assets.initialized) {
		nme.installer.Assets.resourceNames.set("images/cell.png","images/cell.png");
		nme.installer.Assets.resourceTypes.set("images/cell.png","image");
...
org.games = {}
org.games.life = {}
org.games.life.Game = function() {
	browser.display.Sprite.call(this);
	this.gridView = new browser.display.Sprite();
};
$hxClasses["org.games.life.Game"] = org.games.life.Game;
org.games.life.Game.__name__ = ["org","games","life","Game"];
org.games.life.Game.__super__ = browser.display.Sprite;
org.games.life.Game.prototype = $extend(browser.display.Sprite.prototype,{
	getRandomGeneratedGrid: function(gridWidth,gridHeight) {
		if(gridHeight == null) gridHeight = 30;
		if(gridWidth == null) gridWidth = 40;
		...
		while(_g < gridHeight) {
			...
			while(_g1 < gridWidth) {
				var xIndex = _g1++;
				if(Std.random(11) > 5) randomGrid[yIndex][xIndex] = 1; else randomGrid[yIndex][xIndex] = 0;
			}
		}
		return randomGrid;
	}
	,render: function(grid) {
		var newGridView = new browser.display.Sprite();
		newGridView.set_x(0);
		newGridView.set_y(0);
		var _g1 = 0, _g = grid.length;
		while(_g1 < _g) {
			var yIndex = _g1++;
			var _g3 = 0, _g2 = grid[yIndex].length;
			while(_g3 < _g2) {
				var xIndex = _g3++;
				if(grid[yIndex][xIndex] == 1) {
					var filledCell = new browser.display.Sprite();
					filledCell.addChild(new browser.display.Bitmap(nme.installer.Assets.getBitmapData("images/cell.png")));
					filledCell.set_x(xIndex * 16);
					filledCell.set_y(yIndex * 16);
					newGridView.addChild(filledCell);
				}
			}
		}
		if(this.contains(this.gridView)) this.removeChild(this.gridView);
		this.gridView = newGridView;
		this.addChild(this.gridView);
	}
	,tick: function() {
		this.life.updateGrid(this.life.evolve());
		this.render(this.life.getGrid());
	}
	,start: function() {
		this.life = new org.games.life.Life();
		this.life.updateGrid(this.getRandomGeneratedGrid());
		this.render(this.life.getGrid());
		this.timer = new haxe.Timer(500);
		this.timer.run = $bind(this,this.tick);
	}
	,__class__: org.games.life.Game
});
org.games.life.Life = function() {
	this.grid = new Array();
};
$hxClasses["org.games.life.Life"] = org.games.life.Life;
org.games.life.Life.__name__ = ["org","games","life","Life"];
org.games.life.Life.prototype = {
	isCellAlive: function(x,y) {
		return this.grid[y][x] == 1;
	}
	,isCellUnderTest: function(x,y,currentX,currentY) {
		return currentX == x && currentY == y;
	}
	,getEndCoordinate: function(coordinate,arrayLenght) {
		return coordinate >= arrayLenght - 1?arrayLenght:coordinate + 2;
	}
	,getStartCoordinate: function(coordinate) {
	...
	,evolve: function() {
		...
		var _g1 = 0, _g = this.grid.length;
		while(_g1 < _g) {
			var yIndex = _g1++;
			newGrid[yIndex] = new Array();
			var _g3 = 0, _g2 = this.grid[yIndex].length;
			while(_g3 < _g2) {
				var xIndex = _g3++;
				newGrid[yIndex][xIndex] = this.getNextGenerationCellState(this.grid[yIndex][xIndex],this.countNeighbours(xIndex,yIndex));
			}
		}
		return newGrid;
	}
	,countNeighbours: function(x,y) {
		...
		var _g1 = this.getStartCoordinate(y), _g = this.getEndCoordinate(y,this.grid.length);
		while(_g1 < _g) {
			var yIndex = _g1++;
			var _g3 = this.getStartCoordinate(x), _g2 = this.getEndCoordinate(x,this.grid[yIndex].length);
			while(_g3 < _g2) {
				var xIndex = _g3++;
				if(this.isCellUnderTest(x,y,xIndex,yIndex)) continue;
				if(this.isCellAlive(xIndex,yIndex)) neighboursCount++;
			}
		}
	...
	,getNextGenerationCellState: function(parentCellStatus,numberOfNeighbours) {
		if(parentCellStatus == 1 && numberOfNeighbours == 2) return 1;
		if(numberOfNeighbours == 3) return 1;
		return 0;
	}
	,__class__: org.games.life.Life
}
org.games.life.Main = function() {
	this.initialize();
	this.start();
};
$hxClasses["org.games.life.Main"] = org.games.life.Main;
org.games.life.Main.__name__ = ["org","games","life","Main"];
org.games.life.Main.prototype = {
	start: function() {
		var game = new org.games.life.Game();
		nme.Lib.get_current().get_stage().addChild(game);
		game.start();
	}
	,stage_onDeactivate: function(event) {
		com.eclecticdesignstudio.motion.Actuate.pauseAll();
	}
	,stage_onActivate: function(event) {
		com.eclecticdesignstudio.motion.Actuate.resumeAll();
	}
	,initialize: function() {
		...
		nme.Lib.get_current().get_stage().addEventListener(browser.events.Event.ACTIVATE,$bind(this,this.stage_onActivate));
		nme.Lib.get_current().get_stage().addEventListener(browser.events.Event.DEACTIVATE,$bind(this,this.stage_onDeactivate));
	}
	,__class__: org.games.life.Main
}
var $_;
...
com.eclecticdesignstudio.motion.Actuate.defaultEase = com.eclecticdesignstudio.motion.easing.Expo.get_easeOut();
